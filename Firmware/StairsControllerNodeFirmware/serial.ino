...
void handleExternalInput(int origin, String extCommand) {
  ...
  } else if (extCommand.equals("h_u") || extCommand.equals("25")) {
    routeStateChange(origin, "h_u");
  } else if (extCommand.equals("h_d") || extCommand.equals("26")) {
    routeStateChange(origin, "h_d");
  } else if (extCommand.equals("b_e") || extCommand.equals("27")) {
    routeStateChange(origin, "b_e");
  } else if (extCommand.equals("b_r") || extCommand.equals("28")) {
    routeStateChange(origin, "b_r");
  } else if (extCommand.equals("rok") || extCommand.equals("30")) {
    routeStateChange(origin, "rok");
  } else if (extCommand.equals("scl") || extCommand.equals("31")) {
    routeStateChange(origin, "scl");
  } else {
    Serial.println("inv");
  }
}
